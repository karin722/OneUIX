...
data class Preference(
    ...
    data class SystemUI(
        ...
        data class StatusBar(
            ...
            val useCircleBatteryIcon: Boolean = false,
            val circleBatteryIconSizeDp: Float = 16f,
            val circleBatteryIconHorizontalPaddingDp: Float = 0f,
            val circleBatteryIconVerticalPaddingDp: Float = 0f,
            ...
            val statusBarClockDateBeforeTime: Boolean = false,
            val statusBarClockDateTextScale: Float = 0.75f,
            val statusBarClockDateOffsetDp: Float = 1f,
            val statusBarClockDateLocale: String = "",
